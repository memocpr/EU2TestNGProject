...
public class SelectClassX {
    ...
    public void test2() throws InterruptedException {
        ...
        //verify that first selection is "Select a State" or not.
        ...
        Assert.assertEquals(expectedOption,actualOption,"verify first option is Virginia");
        ...
        Assert.assertEquals(expectedOption,actualOption,"verify first option is Wyoming");
        ...
        Assert.assertEquals(expectedOption,actualOption,"verify first option is Distriction of Colombia");
